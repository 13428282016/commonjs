...
module.exports = {
    context: path.join(__dirname, 'public/assets/src/js/library/src'),
    ...
    output: {
        path: path.join(__dirname, 'public/assets/src/js/library'),
    ...
    resolve: {
        ...
        alias: {
            ...
            library: path.join(__dirname, 'public/assets/src/js/library'),
        }
    ...
    externals: [
        //指定那些依赖是不需要打包进js的，而是通过外部导入
        {
            ...
            'library/player': {
                root: 'Player',
                commonjs2: 'library/player',
                commonjs: 'library/player',
                amd: 'library/player'
            }
